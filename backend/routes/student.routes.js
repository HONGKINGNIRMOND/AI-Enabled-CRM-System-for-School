            ...
            for (const row of results) {
                try {
                    ...
                    students.push({
                        ...
                        phone: normalizedRow['phone'] || normalizedRow['phone number'] || null,
                        email: normalizedRow['email'] || normalizedRow['email address'] || null,
                        ...
                        father_name: normalizedRow['father name'] || normalizedRow['father_name'] || normalizedRow["father's name"] || null,
                        father_phone: normalizedRow['father phone'] || normalizedRow['father_phone'] || normalizedRow["father's phone"] || null,
                        father_whatsapp: normalizedRow['father whatsapp'] || normalizedRow['father_whatsapp'] || normalizedRow["father's whatsapp"] || null,
                        father_email: normalizedRow['father email'] || normalizedRow['father_email'] || normalizedRow["father's email"] || null,
                        father_occupation: normalizedRow['father occupation'] || normalizedRow['father_occupation'] || normalizedRow["father's occupation"] || null,
                        mother_name: normalizedRow['mother name'] || normalizedRow['mother_name'] || normalizedRow["mother's name"] || null,
                        mother_phone: normalizedRow['mother phone'] || normalizedRow['mother_phone'] || normalizedRow["mother's phone"] || null,
                        mother_whatsapp: normalizedRow['mother whatsapp'] || normalizedRow['mother_whatsapp'] || normalizedRow["mother's whatsapp"] || null,
                        mother_email: normalizedRow['mother email'] || normalizedRow['mother_email'] || normalizedRow["mother's email"] || null,
                        mother_occupation: normalizedRow['mother occupation'] || normalizedRow['mother_occupation'] || normalizedRow["mother's occupation"] || null
                    });
                } catch (err) {
            ...
            worksheet.eachRow((row, rowNumber) => {
                ...
                try {
                    ...
                    students.push({
                        ...
                        phone: getVal(row, 'Phone', 'Phone Number') || null,
                        email: getVal(row, 'Email', 'Email Address') || null,
                        ...
                        father_name: getVal(row, 'Father Name', "Father's Name") || null,
                        father_phone: getVal(row, 'Father Phone', "Father's Phone") || null,
                        father_whatsapp: getVal(row, 'Father WhatsApp', "Father's WhatsApp") || null,
                        father_email: getVal(row, 'Father Email', "Father's Email") || null,
                        father_occupation: getVal(row, 'Father Occupation', "Father's Occupation") || null,
                        mother_name: getVal(row, 'Mother Name', "Mother's Name") || null,
                        mother_phone: getVal(row, 'Mother Phone', "Mother's Phone") || null,
                        mother_whatsapp: getVal(row, 'Mother WhatsApp', "Mother's WhatsApp") || null,
                        mother_email: getVal(row, 'Mother Email', "Mother's Email") || null,
                        mother_occupation: getVal(row, 'Mother Occupation', "Mother's Occupation") || null
                    });
                } catch (error) {
